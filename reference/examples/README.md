# Ejemplos locales · Sesiones 18–23
...
Desde la raíz del repositorio de formación, `python3 scripts/check-session-materials.py` comprueba enlaces locales, anclas, las imágenes de las sesiones 22 y 23 y que los bloques copiables de las guías y lecciones coincidan con los archivos fuente.
