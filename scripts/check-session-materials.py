"""Check sessions 18–24 and 26: links, slides and copyable source consistency."""
...
for path in pages:
    ...
    if path not in pages[:2]:
        anchor = 'ejemplos-locales' if path.name.startswith(('0023-', 'session-23-', '0024-', 'session-24-', '0026-', 'session-26-')) else 'practica-local'
...
print(f'OK: {len(pages)} HTML pages, 48 PNG slides, local links, example anchors, XML/JSON and literal source blocks.')
